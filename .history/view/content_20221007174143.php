    ...
    <section class="max-w-full">
        <div class="md:block mx-auto md:w-[1200px]">
            ...
            <?php foreach ($showProducts as $show) {
                extract($show);
                echo '<div class="flex justify-between grid grid-cols-1 gap-4 md:grid-cols-4 gap-8 mt-6">
                        ...
                        <div class="flex justify-between items-center">
                            <div class="grid">
                                <div class="grid grid-cols-1">
                                    <span class="line-through text-[20px] font-bold text-gray-900 dark:text-white">'..'0VNĐ</span>
