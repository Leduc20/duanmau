    ...
    <section class="max-w-full">
        <div class="md:block mx-auto md:w-[1200px]">
            ...
            <?php foreach ($showProducts as $show) {
                extract($show);
                echo '<div class="flex justify-between grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6 mt-5">
...
<div class="px-5 pb-5">
    ...
    <div>
    <span class="line-through text-[20px] font-bold text-gray-900 dark:text-white">'.$sale.'</span>
    <span class="text-[20px] font-bold text-gray-900 dark:text-white">$599</span>
    </div>
        <a href="#" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
    </div>
</div>
</div>
            ...
            ?>
            <div class="flex justify-between grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6 mt-5">
...
<div class="w-full max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="px-5 pb-5">
        ...
        <div class="flex justify-between items-center">
            ...
            <span class="line-through text-[20px] font-bold text-gray-900 dark:text-white">$13.000.000</span>
