                        ...
                        <div class="grid grid-cols-3 gap-8">
                            <div>
                                ...
                                foreach ($listline as $show) {
                                    extract($show);
                                    if($id_commodities==UPDATE `products` SET `id_hh`='[value-1]',`name_pro`='[value-2]',`image`='[value-3]',`price`='[value-4]',`detail`='[value-5]',`sale`='[value-6]',`id_commodities`='[value-7]' WHERE 1)
