...
<body>
    <section class="mt-[-366px] ml-[99px]">
        <div class="max-w-[1200px] mx-auto">
            ...
            <div>
                <form action="index.php?act=updatesp" enctype="multipart/form-data">
                    <div class="grid grid-cols-3 gap-8">
                        ...
                        <div>
                            ...
                            <input class="border w-full p-2 rounded-[4px]" type="text" name="sale" id="" value="<?=$price?>">
                        </div>
                        <div>
                    ...
                    <a href="index.php?act=addhh" name="update" type="submit" class="p-2 rounded border mt-3">Cập nhật</a>
