                ...
                <form action="index.php?act=updatesp" method="post" enctype="multipart/form-data">
                    ...
                    <select class="border w-[134px] h-[33px] rounded" name="idlh" id="">
                                ...
                                foreach ($listline as $show) {
                                    extract($show);
                                    if($id_commoditiesd==$id_commodities)
                                    echo '<option value="' . $id_commodities . ' selected">' . $name . '</option> ';
                                    else  echo '<option value="' . $id_commodities . ' selected">' . $name . '</option> ';
                                }
                                ?>
                        ...
                        <div class="grid grid-cols-3 gap-8">
                            ...
                            <div>
                                ...
                                <input class="border w-full p-2 rounded-[4px]" type="text" name="namesp" id="" value="<?=$name?>">
                            </div>
                            <div>
