    ...
    <section class="mt-[-366px] ml-[99px]">
        <div class="max-w-[1200px] mx-auto">
            <div class="border bg-green-200 mt-2 rounded">
                <p class="ml-3 mt-3">Quản lý hàng hóa</p>
            </div>
            <div>
                <form action="" enctype="multipart/form-data">
                    <div class="grid grid-cols-3 gap-8">
                        <div>
                            <p class="font-bold mt-3 mb-2">Mã hàng hóa</p>
                            <input class="border w-full p-2 rounded-[4px]" type="text" name="" id="">
                        </div>
                        <div>
                            <p class="font-bold mt-3 mb-2">Tên hàng hóa</p>
                    ...
                    <a href="index.php?act=addhh" type="submit" class="p-2 rounded border mt-3">Thêm mới</a>
