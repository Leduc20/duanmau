                                    ...
                                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            <?php foreach ($listline as $show) : ?>
                                                ...
                                                <td class="py-4 px-6">
                                                    <a onclick="return confirm('Bạn có muốn xóa không?')" href="index.php?act=deletelh=<?=$show['id_ commodities']?>" class="no-underline text-black px-2 border border-[2px] p2 rounded bg-sky-300 hover:bg-sky-700">Edit</a>
