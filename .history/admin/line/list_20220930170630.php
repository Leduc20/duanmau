                                            ...
                                            <?php foreach ($listline as $show) {
                                                ...
                                                echo '<tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                                    ...
                                                    <td class="py-4 px-6">
                                                        ...
                                                        <a onclick="return confirm("Bạn có muốn xóa không?")" href="'.$delete'" class="no-underline text-black px-2 border border-[2px] p2 rounded bg-sky-300 hover:bg-sky-700">delete</a>
                                                    </td>
                                                </tr>
                                                ';
                                            }
