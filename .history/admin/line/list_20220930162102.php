                                        ...
                                        <tbody>
                                            <?php foreach ($listline as $show) : ?>
                                                ...
                                                <td class="py-4 px-6">
                                                    ...
                                                    <a onclick="return co" href="index.php?act=deletelh=<?=$show['id_ commodities']?>" class="no-underline text-black px-2 border border-[2px] p2 rounded bg-sky-300 hover:bg-sky-700">delete</a>
                                                </td>
                                            </tr>
                                            <?php endforeach ?>
                                            <!-- <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
