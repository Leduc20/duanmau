...
{
    if($filename!=""){
        $sql="UPDATE `products` SET `name`='$name',`image`='$filename',`price`='$price',`detail`='$detail',`sale`='$sale',`id_commodities`='$idlh' where `id_hh`=".$id_hh;
    }else{
        $sql="UPDATE `products` SET `name`='$name',`price`='$price',`detail`='$detail',`sale`='$sale',`id_commodities`='$idlh' where `id_hh`=".$id_hh;
    }
