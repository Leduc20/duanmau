...
<head>
    ...
    <link rel="stylesheet" href="../content/icon/fontawesome-free-6.1.1-web/css/css">
        ...
        <div class="md:flex justify-between mx-auto max-w-[1200px] mt-5 items-center">
            ...
            <div class="hidden md:block">
                <div class="flex">
                    ...
                    <div class="ml-4">
                    <button class="btn btn-primary" type="submit"><i class="mr-[5px] text-black fa-sharp fa-solid fa-cart-arrow-down"></i>Giỏ hàng</button>
                    </div>
                </div>
            </div>
        </div>
