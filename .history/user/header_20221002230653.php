        ...
        <div class="mx-auto max-w bg-cyan-300 mt-2">
            <div class="max-w-[1200px] mx-auto py-2">
                ...
                <ul class="nav nav-pills nav-fill">
                    <li class="nav-item px-2 text-[19px] font-bold hover:bg-sky-500 rounded duration-700">
                    ...
                    <li class="nav-item px-2 text-[19px] font-bold hover:bg-sky-500 rounded  dropdown">
